...
public class MainActivityGlide extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(MainActivityGlide.this);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                MainActivityGlide.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        try{
                                ...
                                public void run() {
                                    ...
                                    new CountDownTimer(900000, 1000) {
                                        ...
                                        public void onFinish() {
                                            Toast.makeText(MainActivityGlide.this, "Pengujian Selesai..", Toast.LENGTH_LONG).show();
                                        }
    ...
    private void initViews(){
        ...
        adapter = new AdapterImageGlide(getApplicationContext(),finalData);
