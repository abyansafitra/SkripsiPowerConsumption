...
public class MainActivityPicasso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pd = new ProgressDialog(MainActivityPicasso.this);
        ...
        client.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                MainActivityPicasso.this.runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        try{
                                ...
                                public void run() {
                                    ...
                                    new CountDownTimer(900000, 1000) {
                                        ...
                                        public void onFinish() {
                                            Toast.makeText(MainActivityPicasso.this, "Pengujian Selesai..", Toast.LENGTH_LONG).show();
                                        }
    ...
    private void initViews(){
        ...
        adapter = new AdapterImagePicasso(getApplicationContext(),finalData);
