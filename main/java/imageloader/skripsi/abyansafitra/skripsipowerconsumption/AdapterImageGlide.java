...
public class AdapterImageGlide extends RecyclerView.Adapter<AdapterImageGlide.ViewHolder> {


    private ArrayList<ModelFoto> listData;
    private Context context;

    public AdapterImageGlide(Context context, ArrayList<ModelFoto> listData) {
    ...
    @Override
    public AdapterImageGlide.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        //pemanggilan glide
        Glide.with(context).load(listData.get(i).getFoto_profil()).into(viewHolder.foto_profil);
        Glide.with(context).load(listData.get(i).getFoto()).into(viewHolder.foto);
    }
